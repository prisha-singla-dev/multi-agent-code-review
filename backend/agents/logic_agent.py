...
PROMPT_TEMPLATE = """You are a Logic & Correctness Code Reviewer. Find ONLY logic issues: edge cases, off-by-one errors, null/None handling, race conditions, silent failures.
...
{{"agent_name":"LogicAgent","issues":[{{"line":"line number or null","description":"issue","severity":"critical|high|medium|low|info","suggestion":"fix"}}],"summary":"one sentence max","score":85}}
